...
ActiveRecord::Schema[7.0].define(version: 2022_10_18_165809) do
  ...
  create_table "dict_lists", force: :cascade do |t|
    ...
    t.index ["grade_id"], name: "index_dict_lists_on_grade_id"
    t.index ["user_id"], name: "index_dict_lists_on_user_id"
  end
  ...
  create_table "user_grades", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["grade_id"], name: "index_user_grades_on_grade_id"
  ...
  add_foreign_key "dict_lists", "grades"
  add_foreign_key "dict_lists", "users"
